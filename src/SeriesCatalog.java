...
public class SeriesCatalog {
  ...
  private static final String[] SeriesName = {"E6" , "E12" , "E24" , "E48" , "E96" , "E192"};
  private static final double[] SeriesPrecision = {20., 15., 5., 2., 1., 0.5};
  ...
  public Series findSeriesByName(String name){
      for (int i = 0; i < SeriesName.length ; i++) {
          if (name.equals(SeriesName[i])) return series.get(i);
      }
    return null;
  }
